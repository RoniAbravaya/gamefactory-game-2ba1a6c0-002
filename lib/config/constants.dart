...
class GameColors {
  ...
  static const Color primary = Color(0xFFF2D7D5);
  static const Color secondary = Color(0xFFD3E0EA);
  static const Color accent = Color(0xFFA9DEF9);
  static const Color success = Color(0xFFE4C1F9);
  static const Color warning = Color(0xFFFAD2E1);
